...
```javascript
headerDir = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-function-object@v0.2.4-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/strided-base-function-object/actions/workflows/test.yml/badge.svg?branch=v0.2.4
[test-url]: https://github.com/stdlib-js/strided-base-function-object/actions/workflows/test.yml?query=branch:v0.2.4
